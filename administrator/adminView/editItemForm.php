...
<?php
	...
	$ID=$_POST['record'];
	$qry=mysqli_query($conn, "SELECT * FROM tbl_product WHERE product_id='$ID'");
...
<form id="update-Items" onsubmit="updateItems()" enctype='multipart/form-data'>
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="p_name" value="<?=$row1['product_name']?>" required>
    </div>
    <div class="form-group">
      <label for="desc">Product Description:</label>
      <input type="text" class="form-control" id="p_desc" value="<?=$row1['product_desc']?>" required>
    </div>
    <div class="form-group">
