...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2023 at 11:28 AM
...
(10, 63, '', 3, 'sd', 'xas', 'Antique', 0, '2023-06-20', 'DV70YOGR'),
(11, 63, '', 3, 'sd', 'xas', 'Antique', 0, '2023-06-20', '3B0E93Y8');
...
(106, 63, 2, 'sinundolan', 'San remigio', 'Antique', 22, 'cash on delivery', 'Pending', '13:35:12', '2023-06-20', 17, 40, 57, 'Correction tape(master) (1) ', 'KQQPHOFM'),
(107, 63, 2, 'sinundolan', 'San remigio', 'Antique', 563, 'cash on delivery', 'Pending', '13:47:38', '2023-06-20', 149, 347, 495, 'Correction tape(master) (3) , Compass (1) , Faber castel ballpen(black)  (1) , Cactus BondPaper(A4) (2) ', 'YH3TBHL3');
...
(65, 'Star water color', 'Produced with high purity pigments, rich luster and easier to mix with water, it is smooth and easy to apply.', 71, './assets/imgstar_water_color-removebg-preview.png', 30, 23, '2023-01-19 19:00:49'),
(66, 'Compass', 'A navigational instrument, it consist of magnetized pointers.', 46, './assets/img668439.png', 20, 37, '2023-01-19 19:00:49'),
(67, 'Correction tape(master)', 'Clean correction tape, made of high quality, smooth and accurate, and easy to fill.', 316, './assets/img526753.png', 22, 37, '2023-01-19 19:00:49'),
(68, 'Simcard(globe)', 'Level up your mobile internet experience with your globe prepaid 5G SIM.', 439, './assets/img144505.png', 40, 40, '2023-01-19 19:00:49'),
...
(70, 'Cactus BondPaper(A4)', 'Standardized copy paper size, dimensions are 210x297mm it is close to equivalent to U.S letter size.', 146, './assets/img416522.png', 230, 24, '2023-01-19 19:00:49');
...
--
ALTER TABLE `tbl_availed`
  MODIFY `avail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
